...
//    discovered devices, and creating a thread for each device to acquire images.
...
void AcquireImages(Arena::IDevice* const pDevice)
{
	...
	for (int i = 0; i < NUM_IMAGES; i++)
	{
		try
		{
			...
			//    Because of this, the timeout should be somewhat larger
...
int main()
{
	...
	try
	{
		...
		// create all discovered devices and add them to a vector
