...
namespace GenTL
{
	...
	enum DEVICE_INFO_CMD_CUSTOM_LIST
	{
		...
		DEVICE_INFO_MULTIPART_ENABLE = 1010,
		DEVICE_INFO_GROUP_VER_MAJOR = 1011,			 /* INT64	Device Goup API major version. */
		DEVICE_INFO_GROUP_VER_MINOR = 1012,			 /* INT64	Device Goup API minor version. */
		DEVICE_INFO_GROUP_ENABLE = 1013,			 /* BOOL	Device Goup is enabled. */
		DEVICE_INFO_GROUP_SERIAL = 1014,			 /* STRING	Device Goup serial. */
		DEVICE_INFO_GROUP_NAME = 1015,				 /* STRING	Device Goup name. */
		DEVICE_INFO_GROUP_MEMBER_COUNT = 1016,		 /* INT64	Device Goup number of members. */
		DEVICE_INFO_GVRSP_STREAMABLE = 1017,		 /* BOOL	Is a device and nic RDMA support available for streaming */
		DEVICE_INFO_MULTIPART_FEATURES_IMPLEMENTED_ENABLE = 1018
	};
	...
	enum ACQ_QUEUE_TYPE_CUSTOM_LIST
	{
		...
		ACQ_QUEUE_OUTPUT_TO_INPUT = ACQ_QUEUE_CUSTOM_ID + 1,
		ACQ_QUEUE_FILL_TO_OUTPUT = ACQ_QUEUE_CUSTOM_ID + 2,
		ACQ_QUEUE_FILL_TO_DISCARD = ACQ_QUEUE_CUSTOM_ID +3
	};
	...
	enum STREAM_INFO_CMD_CUSTOM_LIST
	{
		...
		STREAM_INFO_MULTIPART_NUM_PARTS = 1026
	};
