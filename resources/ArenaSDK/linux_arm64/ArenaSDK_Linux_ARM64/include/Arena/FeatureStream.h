...
namespace Arena
{
	...
	public:
		 ...
		 * will throw an exception and the flag will remain unchanged.
		 *
		 * Trying to select a non-streamable feature will throw an exception. If unsure, check
		 * streamability:
		 *
		 * \code{.cpp}
		 * 	// checking for streamability, only selecting if streamable
		 ...
		 *    streamable.
		 *  - May throw child of GenICam::GenericException.
		 */
