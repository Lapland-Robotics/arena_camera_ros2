...
namespace Arena
{
	...
	public:
		...
		/**
		* @fn virtual int64_t DeviceGroupVersionMajor()
		*
		* @return
		*  - Type: int64_t
		*  - Major Version of the bootstrap register layout for Device Groups
		*
		* <B> DeviceGroupVersionMajor </B> retrieves the major
		* version of the bootstrap register layout for Device Groups. 
		* This will be set to 0 for device that do not support device 
		* grouping features.
		*/
		virtual int64_t DeviceGroupVersionMajor();

		/**
		* @fn virtual int64_t DeviceGroupVersionMinor()
		*
		* @return
		*  - Type: int64_t
		*  - Minor Version of the bootstrap register layout for Device Groups
		*
		* <B> DeviceGroupVersionMinor </B> retrieves the minor
		* version of the bootstrap register layout for Device Groups.
		* This will be set to 0 for device that do not support device
		* grouping features.
		*/
		virtual int64_t DeviceGroupVersionMinor();

		/**
		* @fn virtual bool DeviceGroupEnable()
		*
		* @return
		*  - Type: bool
		*  - True if the device is part of a device group
		*  - Otherwise, false
		*
		* <B> DeviceGroupEnable </B> returns the status of the device 
		* group membership. If this is True then the device is a member
		* of a device group currently.
		*/
		virtual bool DeviceGroupEnable();

		/**
		* @fn virtual int64_t DeviceGroupSerial()
		*
		* @return
		*  - Type: int64_t
		*  - Serial number for Device Groups members
		*
		* <B> DeviceGroupSerial </B> retrieves the common
		* serial number for all devices in this Device Group.
		* This will be set to an empty string for device that do not
		* support device grouping features.
		*/
		virtual GenICam::gcstring DeviceGroupSerial();

		/**
		* @fn virtual int64_t DeviceGroupMemberCount()
		*
		* @return
		*  - Type: int64_t
		*  - Number of members in the Device Group
		*
		* <B> DeviceGroupMemberCount </B> retrieves the number
		* of member devices in this Device Group.
		* This will be set to 0 for device that do not support device
		* grouping features.
		*/
		virtual int64_t DeviceGroupMemberCount();

		/**
		* @fn virtual GenICam::gcstring DeviceGroupName()
		*
		* @return
		*  - Type: GenICam::gcstring
		*  - Shared name for devices in the Device Group
		*
		* <B> DeviceGroupName </B> retrieves the shared name of the device 
		* that is in a Device Group.
		* This will be set to an empty string for devices that do not
		* support device grouping features.
		*/
		virtual GenICam::gcstring DeviceGroupName();
