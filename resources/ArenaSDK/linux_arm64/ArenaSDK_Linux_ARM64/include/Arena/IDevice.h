...
namespace Arena
{
	...
	public:
		 ...
		 *  - 'OldestFirst' is the FIFO buffer handling mode. As buffers are
		 ...
		 *  - 'OldestFirstOverwrite' (Default) is similar to 'OldestFirst' except for
		 ...
		 */
		virtual ICompressedImage* GetCompressedImage(uint64_t timeout) = 0;
		...
		*/
		virtual EvsRawTriggerEvent GetNextEvsTriggerEvent(uint64_t timeout) = 0;
#endif
