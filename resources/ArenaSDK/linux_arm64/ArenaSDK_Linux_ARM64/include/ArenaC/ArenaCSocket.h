...
/**
 * @fn AC_ERROR AC_API acSocketReceiveImage(acSocket hSocket, acBuffer* phBuffer);
 *
 * @param hSocket
 *  - Type: acSocket
 *  - [In] parameter
 ...
 *  - Returns AC_ERR_SUCCESS (0) on success
 *
 * <B> acSocketReceiveImage </B> retrieves a single image sent to the socket and stores it in the specified buffer.
 */
