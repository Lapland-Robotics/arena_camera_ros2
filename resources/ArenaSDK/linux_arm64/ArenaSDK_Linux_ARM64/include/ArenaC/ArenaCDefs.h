...
/**
 * @typedef acIDevFileStream;
 *
 * Represents a GenApi Input FileStream 
 */
typedef void* acIDevFileStream;

/**
 * @typedef acODevFileStream;
 *
 * Represents a GenApi Output FileStream 
 */
typedef void* acODevFileStream;
...
enum AC_PAYLOAD_TYPE_LIST
{
	...
	AC_PAYLOAD_TYPE_COMPRESSED_IMAGE = 1001,					/*!< Compressed image data only */
	AC_PAYLOAD_TYPE_COMPRESSED_IMAGE_EXTENDED_CHUNK = 1002,		/*!< Compressed image data extended with chunk data */
};
...
/**
 * @enum AC_O_DEV_FILE_STREAM_OPEN_MODE_LIST
 *
...
enum AC_O_DEV_FILE_STREAM_OPEN_MODE_LIST
{
	AC_O_DEV_FILE_STREAM_OPEN_MODE_DEFAULT = 0, /*!< Default open mode (out | trunc) */
	AC_O_DEV_FILE_STREAM_OPEN_MODE_OUT = 1,		/*!< Open for output operations */
	AC_O_DEV_FILE_STREAM_OPEN_MODE_BINARY = 2,	/*!< Open in binary mode */
	AC_O_DEV_FILE_STREAM_OPEN_MODE_TRUNC = 4,	/*!< Truncate file if it exists */
	AC_O_DEV_FILE_STREAM_OPEN_MODE_APPEND = 8,	/*!< Append mode */
	AC_O_DEV_FILE_STREAM_OPEN_MODE_ATE = 16		/*!< Open and seek to end immediately */
};

/**
 * @typedef AC_O_DEV_FILE_STREAM_OPEN_MODE;
 *
 * Integer representation of the open mode flags enum
 * (AC_O_DEV_FILE_STREAM_OPEN_MODE_LIST).
 */
typedef int32_t AC_O_DEV_FILE_STREAM_OPEN_MODE;
...
#define LUCID_QOI_Mono8 0x81080A00 /* */
#define LUCID_QOI_BayerGR8 0x81080B00 /* */
#define LUCID_QOI_BayerRG8 0x81080B01 /* */
#define LUCID_QOI_BayerGB8 0x81080B02 /* */
#define LUCID_QOI_BayerBG8 0x81080B03 /* */
#define LUCID_QOI_RGB8 0x82180A01 /* */
#define LUCID_QOI_BGR8 0x82180A02 /* */
#define LUCID_QOI_YCbCr8 0x82180A03 /* */
#define LUCID_QOI_YCbCr8_CbYCr 0x82180A04 /* */
...
#define LUCID_CFA1by2_RB8 0x81080012 /* */
#define LUCID_CFA1by2_RB10 0x8110001a /* */
#define LUCID_CFA1by2_RB10p 0x810a005f /* */
#define LUCID_CFA1by2_RB10Packed 0x810c0034 /* */
#define LUCID_CFA1by2_RB12 0x81100046 /* */
#define LUCID_CFA1by2_RB12p 0x810c0060 /* */
#define LUCID_CFA1by2_RB12Packed 0x810c0076 /* */
#define LUCID_CFA1by2_RB16 0x81100038 /* */
#define LUCID_CFA1by2_BR8 0x81080013 /* */
#define LUCID_CFA1by2_BR10 0x8110001b /* */
#define LUCID_CFA1by2_BR10p 0x810a0060 /* */
#define LUCID_CFA1by2_BR10Packed 0x810c0035 /* */
#define LUCID_CFA1by2_BR12 0x81100047 /* */
#define LUCID_CFA1by2_BR12p 0x810c0061 /* */
#define LUCID_CFA1by2_BR12Packed 0x810c0077 /* */
#define LUCID_CFA1by2_BR16 0x81100039 /* */
#define LUCID_CFA_RBGG8 0x8108000c /* */
#define LUCID_CFA_RBGG10 0x81100014 /* */
#define LUCID_CFA_RBGG10p 0x810a0059 /* */
#define LUCID_CFA_RBGG10Packed 0x810c002e /* */
#define LUCID_CFA_RBGG12 0x81100040 /* */
#define LUCID_CFA_RBGG12p 0x810c005a /* */
#define LUCID_CFA_RBGG12Packed 0x810c0070 /* */
#define LUCID_CFA_RBGG16 0x81100032 /* */
#define LUCID_CFA_BRGG8 0x8108000d /* */
#define LUCID_CFA_BRGG10 0x81100015 /* */
#define LUCID_CFA_BRGG10p 0x810a005a /* */
#define LUCID_CFA_BRGG10Packed 0x810c002f /* */
#define LUCID_CFA_BRGG12 0x81100041 /* */
#define LUCID_CFA_BRGG12p 0x810c005b /* */
#define LUCID_CFA_BRGG12Packed 0x810c0071 /* */
#define LUCID_CFA_BRGG16 0x81100033 /* */
#define LUCID_CFA_GGRB8 0x8108000e /* */
#define LUCID_CFA_GGRB10 0x81100016 /* */
#define LUCID_CFA_GGRB10p 0x810a005b /* */
#define LUCID_CFA_GGRB10Packed 0x810c0030 /* */
#define LUCID_CFA_GGRB12 0x81100042 /* */
#define LUCID_CFA_GGRB12p 0x810c005c /* */
#define LUCID_CFA_GGRB12Packed 0x810c0072 /* */
#define LUCID_CFA_GGRB16 0x81100034 /* */
#define LUCID_CFA_GGBR8 0x8108000f /* */
#define LUCID_CFA_GGBR10 0x81100017 /* */
#define LUCID_CFA_GGBR10p 0x810a005c /* */
#define LUCID_CFA_GGBR10Packed 0x810c0031 /* */
#define LUCID_CFA_GGBR12 0x81100043 /* */
#define LUCID_CFA_GGBR12p 0x810c005d /* */
#define LUCID_CFA_GGBR12Packed 0x810c0073 /* */
#define LUCID_CFA_GGBR16 0x81100035 /* */
#define LUCID_CFA2by1_WB8 0x81080014 /* */
#define LUCID_CFA2by1_WB10 0x8110001c /* */
#define LUCID_CFA2by1_WB10p 0x810a0061 /* */
#define LUCID_CFA2by1_WB10Packed 0x810c0036 /* */
#define LUCID_CFA2by1_WB12 0x81100048 /* */
#define LUCID_CFA2by1_WB12p 0x810c0062 /* */
#define LUCID_CFA2by1_WB12Packed 0x810c0078 /* */
#define LUCID_CFA2by1_WB16 0x8110003a /* */
#define LUCID_CFA2by1_BW8 0x81080015 /* */
#define LUCID_CFA2by1_BW10 0x8110001d /* */
#define LUCID_CFA2by1_BW10p 0x810a0062 /* */
#define LUCID_CFA2by1_BW10Packed 0x810c0037 /* */
#define LUCID_CFA2by1_BW12 0x81100049 /* */
#define LUCID_CFA2by1_BW12p 0x810c0063 /* */
#define LUCID_CFA2by1_BW12Packed 0x810c0079 /* */
#define LUCID_CFA2by1_BW16 0x8110003b /* */
#define LUCID_CFA4by1_WBGR8 0x81080010 /* */
#define LUCID_CFA4by1_WBGR10 0x81100018 /* */
#define LUCID_CFA4by1_WBGR10p 0x810a005d /* */
#define LUCID_CFA4by1_WBGR10Packed 0x810c0032 /* */
#define LUCID_CFA4by1_WBGR12 0x81100044 /* */
#define LUCID_CFA4by1_WBGR12p 0x810c005e /* */
#define LUCID_CFA4by1_WBGR12Packed 0x810c0074 /* */
#define LUCID_CFA4by1_WBGR16 0x81100036 /* */
#define LUCID_CFA4by1_RGBW8 0x81080011 /* */
#define LUCID_CFA4by1_RGBW10 0x81100019 /* */
#define LUCID_CFA4by1_RGBW10p 0x810a005e /* */
#define LUCID_CFA4by1_RGBW10Packed 0x810c0033 /* */
#define LUCID_CFA4by1_RGBW12 0x81100045 /* */
#define LUCID_CFA4by1_RGBW12p 0x810c005f /* */
#define LUCID_CFA4by1_RGBW12Packed 0x810c0075 /* */
#define LUCID_CFA4by1_RGBW16 0x81100037 /* */
#define LUCID_RGBY8 0x82200001 /* */
#define LUCID_BGRY8 0x82200002 /* */
...
#define LUCID_Coord3D_Y16 0x82100405 /* 3d, 32-to-16-bit, non-unique-identifier */
...
#define LUCID_DualMono8_2ch 0x81101001 /* */
#define LUCID_DualMono10_2ch 0x81201003 /* */
#define LUCID_DualMono12_2ch 0x81201005 /* */
#define LUCID_DualMono16_2ch 0x81201007 /* */
#define LUCID_DualBayerRG8_2ch 0x81101009 /* */
#define LUCID_DualBayerRG10_2ch 0x8120100D /* */
#define LUCID_DualBayerRG12_2ch 0x81201011 /* */
#define LUCID_DualBayerRG16_2ch 0x8120102F /* */
#define LUCID_DualBayerGR8_2ch 0x81101008 /* */
#define LUCID_DualBayerGR10_2ch 0x8120100C /* */
#define LUCID_DualBayerGR12_2ch 0x81201010 /* */
#define LUCID_DualBayerGR16_2ch 0x8120102E /* */
#define LUCID_DualBayerBG8_2ch 0x8110100B /* */
#define LUCID_DualBayerBG10_2ch 0x8120100F /* */
#define LUCID_DualBayerBG12_2ch 0x81201013 /* */
#define LUCID_DualBayerBG16_2ch 0x81201031 /* */
#define LUCID_DualBayerGB8_2ch 0x8110100A /* */
#define LUCID_DualBayerGB10_2ch 0x8120100E /* */
#define LUCID_DualBayerGB12_2ch 0x81201012 /* */
#define LUCID_DualBayerGB16_2ch 0x81201030 /* */
#define LUCID_QuadMono8_4ch 0x81203001 /* */
#define LUCID_QuadMono10_4ch 0x81403003 /* */
#define LUCID_QuadMono12_4ch 0x81403005 /* */
#define LUCID_QuadMono16_4ch 0x81403007 /* */
#define LUCID_QuadBayerRG8_4ch 0x81203009 /* */
#define LUCID_QuadBayerRG10_4ch 0x8140300D /* */
#define LUCID_QuadBayerRG12_4ch 0x81403011 /* */
#define LUCID_QuadBayerRG16_4ch 0x8140302F /* */
#define LUCID_QuadBayerGR8_4ch 0x81203008 /* */
#define LUCID_QuadBayerGR10_4ch 0x8140300C /* */
#define LUCID_QuadBayerGR12_4ch 0x81403010 /* */
#define LUCID_QuadBayerGR16_4ch 0x8140302E /* */
#define LUCID_QuadBayerBG8_4ch 0x8120300B /* */
#define LUCID_QuadBayerBG10_4ch 0x8140300F /* */
#define LUCID_QuadBayerBG12_4ch 0x81403013 /* */
#define LUCID_QuadBayerBG16_4ch 0x81403031 /* */
#define LUCID_QuadBayerGB8_4ch 0x8120300A /* */
#define LUCID_QuadBayerGB10_4ch 0x8140300E /* */
#define LUCID_QuadBayerGB12_4ch 0x81403012 /* */
#define LUCID_QuadBayerGB16_4ch 0x81403030 /* */
#define LUCID_LucidXYTP128f 0x82804556 /* */
#ifdef __cplusplus
} // extern "C"
#endif
