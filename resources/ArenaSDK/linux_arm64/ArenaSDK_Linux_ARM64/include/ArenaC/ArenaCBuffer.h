...
/**
 * @fn AC_ERROR AC_API acBufferIsCompressedImage(acBuffer hBuffer, bool8_t* pIsCompressedImage)
 *
 * @param hBuffer
 *  - Type: acBuffer
 *  - [In] parameter
 ...
 */
AC_ERROR AC_API acBufferIsCompressedImage(acBuffer hBuffer, bool8_t* pHasImageData);
